...
public final class Hdfs {
  ...
  public interface BlockReportResponseOrBuilder extends
    ...
    /**
     * <code>repeated int32 deleteBlocks = 2;</code>
     *
     * <pre>
     *list of blocks that need to be deleted.
     * </pre>
     */
    java.util.List<java.lang.Integer> getDeleteBlocksList();
    /**
     * <code>repeated int32 deleteBlocks = 2;</code>
     *
     * <pre>
  ...
  public  static final class BlockReportResponse extends
    ...
    private BlockReportResponse() {
      ...
      deleteBlocks_ = java.util.Collections.emptyList();
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                deleteBlocks_ = new java.util.ArrayList<java.lang.Integer>();
                mutable_bitField0_ |= 0x00000002;
              }
              deleteBlocks_.add(input.readInt32());
              break;
            }
            case 18: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
          deleteBlocks_ = java.util.Collections.unmodifiableList(deleteBlocks_);
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    private java.util.List<java.lang.Integer> deleteBlocks_;
    /**
     * <code>repeated int32 deleteBlocks = 2;</code>
     *
     * <pre>
     ...
     * </pre>
     */
    public int getDeleteBlocks(int index) {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < deleteBlocks_.size(); i++) {
        output.writeInt32(2, deleteBlocks_.get(i));
      }
      if (((bitField0_ & 0x00000001) == 0x00000001)) {
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < deleteBlocks_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt32SizeNoTag(deleteBlocks_.get(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends
      ...
      private java.util.List<java.lang.Integer> deleteBlocks_ = java.util.Collections.emptyList();
      private void ensureDeleteBlocksIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          deleteBlocks_ = new java.util.ArrayList<java.lang.Integer>(deleteBlocks_);
          bitField0_ |= 0x00000002;
         }
      }
      /**
      ...
      public java.util.List<java.lang.Integer>
          getDeleteBlocksList() {
        return java.util.Collections.unmodifiableList(deleteBlocks_);
      }
      /**
       * <code>repeated int32 deleteBlocks = 2;</code>
       *
       ...
       * </pre>
       */
      public Builder addDeleteBlocks(int value) {
        ensureDeleteBlocksIsMutable();
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\016\n\006handle\030\002 \001(\005\022\021\n\tblockNums\030\003 \003(\005\022\014\n\004s" +
      "ize\030\004 \001(\005\"4\n\020CloseFileRequest\022\016\n\006handle\030" +
      "\001 \001(\005\022\020\n\010decision\030\002 \001(\005\"#\n\021CloseFileResp" +
      "onse\022\016\n\006status\030\001 \001(\005\"f\n\021WriteBlockReques" +
      "t\022\"\n\tblockInfo\030\001 \001(\0132\017.BlockLocations\022\014\n" +
      "\004data\030\002 \003(\014\022\020\n\010isAppend\030\003 \001(\010\022\r\n\005count\030\004" +
      ...
      "ns\030\002 \003(\0132\017.BlockLocations\"$\n\022AssignBlock" +
      "Request\022\016\n\006handle\030\001 \001(\005\"H\n\023AssignBlockRe" +
      "sponse\022\016\n\006status\030\001 \001(\005\022!\n\010newBlock\030\002 \001(\013" +
      "2\017.BlockLocations\"#\n\020ListFilesRequest\022\017\n",
      ...
      "location\030\002 \001(\0132\021.DataNodeLocation\022\024\n\014blo" +
      "ckNumbers\030\003 \003(\005\"`\n\023BlockReportResponse\022\016" +
      "\n\006status\030\001 \003(\005\022\024\n\014deleteBlocks\030\002 \003(\005\022#\n\010" +
      "location\030\003 \001(\0132\021.DataNodeLocation\"\036\n\020Hea" +
    ...
    internal_static_OpenFileResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_OpenFileResponse_descriptor,
        new java.lang.String[] { "Status", "Handle", "BlockNums", "Size", });
    internal_static_CloseFileRequest_descriptor =
    ...
    internal_static_WriteBlockRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_WriteBlockRequest_descriptor,
        new java.lang.String[] { "BlockInfo", "Data", "IsAppend", "Count", });
    internal_static_WriteBlockResponse_descriptor =
